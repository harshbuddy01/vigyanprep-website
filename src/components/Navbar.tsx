  ...
  return (
    <>
      ...
      <div className="fixed top-5 left-6 sm:left-10 z-50 flex items-center">
        ...
        >
          <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-amber-400 via-amber-500 to-amber-600 text-black font-serif font-extrabold text-base flex items-center justify-center shadow-md shadow-amber-500/20">
            V
          </div>
          <div className="text-left">
            <span className="font-serif italic font-extrabold text-base text-amber-100 tracking-tight">
              VIGYAN<span className="font-sans text-[10px] uppercase text-amber-400 font-extrabold ml-1">.prep</span>
            </span>
            <span className="block text-[7px] font-extrabold tracking-widest text-amber-400/90 uppercase">RESEARCH ENTRANCES</span>
          </div>
        </Link>
      </div>
